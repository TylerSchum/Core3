...
dathomir_rancor_bull_lair_neutral_large2 = Lair:new {
	mobiles = {{"enraged_bull_rancor",1}},
	bossMobiles = {{"ancient_bull_rancor",1}},
	spawnLimit = 15,
...
addLairTemplate("dathomir_rancor_bull_lair_neutral_large2", dathomir_rancor_bull_lair_neutral_large2)
