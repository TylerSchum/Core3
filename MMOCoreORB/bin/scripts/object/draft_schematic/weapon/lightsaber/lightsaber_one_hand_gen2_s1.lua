...
object_draft_schematic_weapon_lightsaber_lightsaber_one_hand_gen2_s1 = object_draft_schematic_weapon_lightsaber_shared_lightsaber_one_hand_gen2_s1:new {
...
--   contribution = {100, 100, 100, 100, 100, 100, 100},
   ...
   ingredientTitleNames = {"emitter_shroud", "primary_crystal", "activator", "handgrip", "focusing_crystals", "power_field_insulator", "energizers"},
   ingredientSlotType = {0, 1, 0, 0, 1, 0, 0},
   resourceTypes = {"metal", "object/weapon/melee/sword/crafted_saber/shared_sword_lightsaber_one_handed_s1_gen1.iff", "metal_nonferrous", "petrochem_inert", "object/tangible/component/weapon/lightsaber/shared_lightsaber_refined_crystal_pack.iff", "gas_inert_known", "metal_nonferrous"},
   resourceQuantities = {25, 1, 18, 20, 1, 22, 20},
   contribution = {100, 100, 100, 100, 100, 100, 100},


   targetTemplate = "object/weapon/melee/sword/crafted_saber/shared_sword_lightsaber_one_handed_s2_gen2.iff",--"object/weapon/melee/sword/crafted_saber/sword_lightsaber_one_handed_gen2.iff",
...
ObjectTemplates:addTemplate(object_draft_schematic_weapon_lightsaber_lightsaber_one_hand_gen2_s1, "object/draft_schematic/weapon/lightsaber/lightsaber_one_hand_gen2.iff")
