general_store_vendor = ScreenPlay:new {                
  numberOfActs = 1,                
  questString = "general_store_vendor_task",                   
  states = {}, 
}
registerScreenPlay("general_store_vendor", true)
function general_store_vendor:start()     
  -- Spawn our character into the world, setting pLarry a pointer variable we can use to check or change his state. 
  local pWeaponsmith = spawnMobile("corellia", "general_store_vendor", 1, -157, 28.0, -4724, 35, 0 )--cnet
  local pWeaponsmith1 = spawnMobile("corellia", "general_store_vendor", 1, -5042, 21.0, -2297, 35, 0 )--tyrena
  local pWeaponsmith2 = spawnMobile("corellia", "general_store_vendor", 1, -3138, 31.0, 2796, 35, 0 )--korvella   
  local pWeaponsmith2 = spawnMobile("corellia", "general_store_vendor", 1, 3333, 308.0, 5524, 35, 0 )--doaba   
  local pWeaponsmith2 = spawnMobile("corellia", "general_store_vendor", 1, -5550, 15.58, -6061, 35, 0 )--venri  
  local pWeaponsmith2 = spawnMobile("corellia", "general_store_vendor", 1, 6643.02,330.00,-5920.87, 35, 0 )--belav  

  local pWeaponsmith3 = spawnMobile("naboo", "general_store_vendor", 1, -4872, 6.0, 4151, 35, 0 )--theed
  local pWeaponsmith4 = spawnMobile("naboo", "general_store_vendor", 1, 4807, 4.0, -4705, 35, 0 )--moena
  local pWeaponsmith5 = spawnMobile("naboo", "general_store_vendor", 1, 5200, -192.0, 6677, 35, 0 )--kaadara
  local pWeaponsmith5 = spawnMobile("naboo", "general_store_vendor", 1, 1444, 14.0, 2777, 35, 0 )--keren
  local pWeaponsmith5 = spawnMobile("naboo", "general_store_vendor", 1, 5331.16,326.95,-1576.12, 35, 0 )--deja
  local pWeaponsmith5 = spawnMobile("naboo", "general_store_vendor", 1, -5495.62,-150.00,-24.69, 35, 0 )--lake ret

  local pWeaponsmith3 = spawnMobile("tatooine", "general_store_vendor", 1, 3522, 5.0, -4803, 35, 0 )--eisley
  local pWeaponsmith4 = spawnMobile("tatooine", "general_store_vendor", 1, -1281, 12.0, -3590, 35, 0 )--bestine
  local pWeaponsmith5 = spawnMobile("tatooine", "general_store_vendor", 1, -2914, 5.0, 2129, 35, 0 )--espa
  local pWeaponsmith5 = spawnMobile("tatooine", "general_store_vendor", 1, 1293, 7.0, 3140, 35, 0 )--entha
  local pWeaponsmith5 = spawnMobile("tatooine", "general_store_vendor", 1, 48.33,52.00,-5340.53, 35, 0 )--anc 

  local pWeaponsmith4 = spawnMobile("talus", "general_store_vendor", 1, -2193, 20.0, 2313, 35, 0 )--talus imp
  local pWeaponsmith4 = spawnMobile("talus", "general_store_vendor", 1, 4447, 2.0, 5271, 35, 0 )--nashal
  local pWeaponsmith4 = spawnMobile("talus", "general_store_vendor", 1, 338, 6.0, -2931, 35, 0 )--dearic

  local pWeaponsmith4 = spawnMobile("rori", "general_store_vendor", 1, 5365, 80.0, 5657, 35, 0 )--restuss
  local pWeaponsmith4 = spawnMobile("rori", "general_store_vendor", 1, -5305, 80.0, -2228, 35, 0 )--narmle             
  local pWeaponsmith4 = spawnMobile("rori", "general_store_vendor", 1, 3683, 96.0, -6436, 35, 0 )--reb

  local pWeaponsmith4 = spawnMobile("endor", "general_store_vendor", 1, -948, 73.0, 1550, 35, 0 )--smugglers
  local pWeaponsmith4 = spawnMobile("endor", "general_store_vendor", 1, 3201, 24.0, -3501, 35, 0 )--research

  local pWeaponsmith4 = spawnMobile("dantooine", "general_store_vendor", 1, -638, 3.0, 2505, 35, 0 )--mining
  local pWeaponsmith4 = spawnMobile("dantooine", "general_store_vendor", 1, -4209, 3.0, -2349, 35, 0 )--imp
  local pWeaponsmith4 = spawnMobile("dantooine", "general_store_vendor", 1, 1564, 4.0, -6415, 35, 0 )--aggro

  local pWeaponsmith4 = spawnMobile("dathomir", "general_store_vendor", 1, 619, 3.0, 3090, 35, 0 )--trade
  local pWeaponsmith4 = spawnMobile("dathomir", "general_store_vendor", 1, -47, 18.0, -1586, 35, 0 )--science

  local pWeaponsmith4 = spawnMobile("yavin4", "general_store_vendor", 1, -265, 35.0, 4897, 35, 0 )--mining
  local pWeaponsmith4 = spawnMobile("yavin4", "general_store_vendor", 1, 4053, 17.0, -6217, 35, 0 )--imp
  local pWeaponsmith4 = spawnMobile("yavin4", "general_store_vendor", 1, -6922, 73.0, -5730, 35, 0 )--labor

  local pWeaponsmith4 = spawnMobile("lok", "general_store_vendor", 1, 479, 8.0, 5512, 35, 0 )--lok

--    local pWeaponsmith4 = spawnMobile("endor", "general_store_vendor", 1, -4964, 9.0, 3620, 35, 0 )--pcity
--    local pWeaponsmith4 = spawnMobile("dantooine", "general_store_vendor", 1, -5731.72, 2.01,6574.19, 35, 0 )--pcity
--    local pWeaponsmith2 = spawnMobile("corellia", "general_store_vendor", 1, -1453.02,10.00,-3211.87, 35, 0 )--pc  
--    local pWeaponsmith5 = spawnMobile("tatooine", "general_store_vendor", 1, 5767.33,20.00,4408.53, 35, 0 )--pc
--    local pWeaponsmith2 = spawnMobile("corellia", "general_store_vendor", 1, 3184.02,10.00,-6778.87, 35, 0 )--pc  
...
general_store_vendor_convo_handler = Object:new {
  tstring = "myconversation" 
}
function general_store_vendor_convo_handler:getNextConversationScreen(conversationTemplate, conversingPlayer, selectedOption)            
...
--DROIDS  
  ...
  function general_store_vendor_convo_handler:runScreenHandlers(conversationTemplate, conversingPlayer, conversingNPC, selectedOption, conversationScreen)
