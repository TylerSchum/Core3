...
function TatooineStaticSpawnsNorthScreenPlay:spawnMobiles()
	...
	spawnMobile("tatooine", "canyon_krayt_dragon", 300, -6216.0, 30.8, 5033.9, 63, 0)
	spawnMobile("tatooine", "juvenile_canyon_krayt_dragon", 300, 6213.8, 31.0, 5021.3, 63, 0)
	...
	spawnMobile("tatooine", "giant_canyon_krayt_dragon", 300, 5728.5, 56.6, 3784.7, 35, 0)
	...
	spawnMobile("tatooine", "krayt_dragon_grand", 300, -6718.3, 175.6, 3499.6, 80, 0)
	spawnMobile("tatooine", "krayt_dragon_grand", 300, -6796.1, 194.0, 3514.6, 175, 0)
	spawnMobile("tatooine", "krayt_dragon_adolescent", 300, -6789.0, 127.7, 3661.2, -104, 0)
