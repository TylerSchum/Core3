general_store_vendor_conv = ConvoTemplate:new {
  initialScreen = "first_screen",
  templateType = "Lua",
  luaClassHandler = "general_store_vendor_convo_handler",
  screens = {}
}
general_store_vendor_first_screen = ConvoScreen:new {
  id = "first_screen",
  leftDialog = "",
...
general_store_vendor_conv:addScreen(general_store_vendor_first_screen);
...
general_store_vendor_conv:addScreen(weaps1);
...
general_store_vendor_conv:addScreen(armor1);
...
general_store_vendor_conv:addScreen(art1);
...
general_store_vendor_conv:addScreen(arch1);
...
general_store_vendor_conv:addScreen(chef1);
...
general_store_vendor_conv:addScreen(loot1);
...
general_store_vendor_conv:addScreen(doc1);
...
general_store_vendor_conv:addScreen(droid1);
...
general_store_vendor_conv:addScreen(tailor1);
...
general_store_vendor_conv:addScreen(newbuff1);

general_store_vendor_accept_quest = ConvoScreen:new {    
  id = "buff1",
  leftDialog = "",
...
general_store_vendor_conv:addScreen(general_store_vendor_accept_quest);
general_store_vendor_deny_quest = ConvoScreen:new {
  id = "deny_quest",
  leftDialog = "",
...
general_store_vendor_conv:addScreen(general_store_vendor_deny_quest);
general_store_vendor_insufficient_funds = ConvoScreen:new {
...
general_store_vendor_conv:addScreen(general_store_vendor_insufficient_funds);
general_store_vendor_insufficient_space = ConvoScreen:new {
...
general_store_vendor_conv:addScreen(general_store_vendor_insufficient_space);
addConversationTemplate("general_store_vendor_conv", general_store_vendor_conv);